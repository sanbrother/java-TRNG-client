...
public class SimpleLog implements Log, Serializable {
    ...
    protected void write(StringBuilder buffer) {
                ...
                try {
                    ...
                    if (e.getTargetException() instanceof SecurityException) {
                    	...
                    	RuntimeException t = null;
                    	  try {
                    	  	t = (RuntimeException) Class.forName("org.apache.commons.logging.LogConfigurationException")
                    	  	     .getConstructor(String.class,Throwable.class)
                    	  	     .newInstance("Unexpected InvocationTargetException", e.getTargetException());
                    	  } catch (Exception cnfe) {
                    	  	t = new RuntimeException("Unexpected InvocationTargetException", e.getTargetException());
                    	  }
                    	  throw t;
                    }
                }
